...
public class RevenueAggregationJob {
    ...
    private static final String SINK_TOPIC = "revenue-by-category";
    ...
    public static void main(String[] args) throws Exception {
        ...
        DataStream<RevenueByCategory> revenueStream = defineWorkflow(orderStream);
        ...
        if ("true".equalsIgnoreCase(icebergEnabled)) {
            ...
            icebergSink.attachRevenueSink(revenueStream, "olist", "revenue_by_category");
        }
    ...
    public static DataStream<RevenueByCategory> defineWorkflow(DataStream<OrderEvent> orderStream) {
        return orderStream
                .filter(event -> event.getProductCategory() != null && event.getPrice() != null)
